...
resource "aws_subnet" "private" {
  ...
  ipv6_cidr_block                                 = try(var.vpc_settings.enable_aws_ipv6_cidr_block.private_cidr_count_prefix64 != 0 ? cidrsubnet(aws_vpc.vpc.ipv6_cidr_block, 8, try(var.vpc_settings.enable_aws_ipv6_cidr_block.public_cidr_count_prefix64, 0) + count.index) : null)
