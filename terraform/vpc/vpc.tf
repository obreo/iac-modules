...
resource "aws_vpc" "vpc" {
  ...
  assign_generated_ipv6_cidr_block = var.vpc_settings.enable_aws_ipv6_cidr_block != null ? (var.vpc_settings.enable_aws_ipv6_cidr_block.ipv6_native == true || var.vpc_settings.enable_aws_ipv6_cidr_block.public_cidr_count_prefix64 != 0 || var.vpc_settings.enable_aws_ipv6_cidr_block.private_cidr_count_prefix64 != 0 ? true : false) : false
...
resource "aws_subnet" "private" {
  count                                           = try(var.vpc_settings.enable_aws_ipv6_cidr_block.ipv6_native, false) || try(var.vpc_settings.enable_aws_ipv6_cidr_block.private_cidr_count_prefix64, 0) != 0 ? try(var.vpc_settings.enable_aws_ipv6_cidr_block.private_cidr_count_prefix64, 0) : length(var.vpc_settings.private_subnet_cidr_blocks)
  vpc_id                                          = aws_vpc.vpc.id
  ...
  ipv6_cidr_block                                 = try(var.vpc_settings.enable_aws_ipv6_cidr_block.private_cidr_count_prefix64, 0) != 0 ? cidrsubnet(aws_vpc.vpc.ipv6_cidr_block, 8, try(var.vpc_settings.enable_aws_ipv6_cidr_block.public_cidr_count_prefix64, 0) + count.index) : null
